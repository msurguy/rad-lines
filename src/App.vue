<template>
  <div class="d-flex" id="wrapper">
    ...
    <div id="sidebar-wrapper">
      ...
      <text-input :left-icon="startAngle.leftIcon" :right-icon="startAngle.rightIcon" label="Scale Formula" @reset="resetScaleFormula" v-model="scaleFormula"></text-input>
      <text-input :left-icon="startAngle.leftIcon" :right-icon="startAngle.rightIcon" label="Rotation Formula" @reset="resetRotationFormula" v-model="rotationFormula"></text-input>
